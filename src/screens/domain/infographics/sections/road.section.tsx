...
const RoadData = [
    {
        title: 'Road condition from Northgate to Agbogbo junction and back',
        image: require('../../../../assets/images/info3.png'),
        sh: 'first'
    },
    {
        title: 'Road condition from Nepa bus stop to Iralegbo and back',
        image: require('../../../../assets/images/info3.png'),
        sh: 'second'
    },
    {
        title: 'Road condition from Southgate to high court junction/S.O and back',
        image: require('../../../../assets/images/info3.png'),
        sh: 'third'
    }
]
  ...
  return (
    ...
    { toShow == 'first' && (
        <View style={styles.tr}>
            <TouchableOpacity onPress={() => setToShow('')}>
             ...
             <Image source={require('../../../../assets/images/road1.png')} style={styles.tri} resizeMode="contain" />
        </View>
    )}
    ...
    { toShow == 'second' && (
        <View style={styles.tr}>
            <TouchableOpacity onPress={() => setToShow('')}>
             ...
             <Image source={require('../../../../assets/images/road2.png')} style={styles.tri} resizeMode="contain" />
        </View>
    )}
    ...
    { toShow == 'third' && (
        <View style={styles.tr}>
            ...
            <Image source={require('../../../../assets/images/road3.png')} style={styles.tri} resizeMode="contain" />
        </View>
    )}
