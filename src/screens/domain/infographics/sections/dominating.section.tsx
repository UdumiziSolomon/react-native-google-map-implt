...
const DominatingData = [
    {
        title: 'Dominating Land use from Northgate to Agbogbo junction and back',
        image: require('../../../../assets/images/info1.png'),
        sh: 'first'
    },
    {
        title: 'Dominating Land use from Nepa bus stop to Iralegbo and back',
        image: require('../../../../assets/images/info1.png'),
        sh: 'second'
    },
    {
        title: 'Dominating Land use from Southgate to high court junction/S.O and back',
        image: require('../../../../assets/images/info1.png'),
        sh: 'third'
    }
]
  ...
  return (
    ...
    { toShow == 'first' && (
        <View style={styles.tr}>
            <TouchableOpacity onPress={() => setToShow('')}>
             ...
             <Image source={require('../../../../assets/images/dom2.png')} style={styles.tri} resizeMode="contain" />
        </View>
    )}
    ...
    { toShow == 'second' && (
        <View style={styles.tr}>
            <TouchableOpacity onPress={() => setToShow('')}>
             ...
             <Image source={require('../../../../assets/images/dom3.png')} style={styles.tri} resizeMode="contain" />
        </View>
    )}
    ...
    { toShow == 'third' && (
        <View style={styles.tr}>
            ...
            <Image source={require('../../../../assets/images/dom1.png')} style={styles.tri} resizeMode="contain" />
        </View>
    )}
