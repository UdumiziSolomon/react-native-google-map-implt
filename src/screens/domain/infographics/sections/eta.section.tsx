...
const EtaData = [
    {
        title: 'ETA from Northgate to Agbogbo junction and back',
        image: require('../../../../assets/images/info2.png'),
        sh: 'first'
    },
    {
        title: 'ETA from Nepa bus stop to Iralegbo and back',
        image: require('../../../../assets/images/info2.png'),
        sh: 'second'
    },
    {
        title: 'ETA from Southgate to high court junction/S.O and back',
        image: require('../../../../assets/images/info2.png'),
        sh: 'third'
    }
]
  ...
  return (
    ...
    { toShow == 'first' && (
        <View style={styles.tr}>
            <TouchableOpacity onPress={() => setToShow('')}>
             ...
             <Image source={require('../../../../assets/images/eta1.png')} style={styles.tri} resizeMode="contain" />
        </View>
    )}
    ...
    { toShow == 'second' && (
        <View style={styles.tr}>
            <TouchableOpacity onPress={() => setToShow('')}>
             ...
             <Image source={require('../../../../assets/images/eta2.png')} style={styles.tri} resizeMode="contain" />
        </View>
    )}
    ...
    { toShow == 'third' && (
        <View style={styles.tr}>
            ...
            <Image source={require('../../../../assets/images/eta3.png')} style={styles.tri} resizeMode="contain" />
        </View>
    )}
